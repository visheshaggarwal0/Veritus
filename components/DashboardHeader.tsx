...
export function DashboardHeader({ currentUser }: DashboardHeaderProps) {
  ...
  return (
    <>
      <header className="h-20 border-b border-zinc-100 bg-white/70 backdrop-blur-3xl px-10 flex items-center justify-between shrink-0 z-40 sticky top-0">
        <div className="flex items-center gap-4 bg-zinc-50 px-5 py-2.5 rounded-xl border border-zinc-100 w-[450px] transition-all focus-within:w-[500px] focus-within:border-zinc-300 focus-within:bg-white focus-within:shadow-sm">
